...
class AdminProcurementPlanController extends Controller
{
    public function ProcurementPlanType()
    {
        ...
        return view('admin.post.procurement_plan.page_type', compact('ProcurementPlanType'));
    }
    ...
    public function ProcurementPlanShowDetail($id)
    {
        ...
        return view('admin.post.procurement_plan.page_details', compact('ProcurementPlanType', 'ProcurementPlanFile'));
    }
