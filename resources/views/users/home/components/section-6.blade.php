    ...
    <div class="container ">
        <div class="row w-100">
            <div class="col-xl-6 d-flex flex-column justify-content-center align-items-center">
                ...
                <img src="{{ asset('pages/home/section-6/กรอบข่าวประชาสัมพันธ์.png') }}" alt="topper"
                ...
                <div class="bg-blue-section6 d-flex flex-column justify-content-center px-3 py-4">
                    @for ($i = 0; $i < 3; $i++)
                        <a href="#"
                            class="bg-card-section6 pt-2 px-3 pb-4 d-flex flex-column justify-content-center align-items-center  mb-2">
                            <div class="d-flex flex-column flex-md-row justify-content-center align-items-start gap-2">
                                <img src="{{ asset('pages/home/section-6/ปกข่าวประชาสัมพันธ์.png') }}" alt="logo"
                                    class="bg-white">
                                <div class="text d-flex flex-column justify-content-center">
                                    <div
                                        class="text-dark bg-white py-1 py-md-3 py-lg-1 py-xl-3 px-3 lh-sm fs-6 rounded-4">
                                        <?php
                            ...
                            <div class="bg-white text-dark fw-bold d-flex justify-content-center align-items-center py-1 px-2 rounded-4 text-decoration control-date"
                                style="position: absolute; font-size:14px;">
                                <img src="{{ asset('pages/home/section-6/นาฬิกา.png') }}" alt="clock"
                                    style="width: 15px; height:15px;" class="me-1">
                                dd/mm/yyyy
                            </div>
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center">
                    <div class="d-flex flex-column justify-content-center align-items-center mt-4">
                        <a href="#" class="banner-hover px-3 py-1">
                            <img src="{{ asset('pages/home/section-6/BN เฟสบุ๊ค.png') }}" alt="facebook"
                                class="img-fluid ">
                        </a>
                        <a href="#" class="banner-hover px-3 py-1">
                            <img src="{{ asset('pages/home/section-6/BN ห้องสมุด.png') }}" alt="e-library"
                                class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 d-flex flex-column mt-5">
            <div class="bg-white d-flex flex-column justify-content-center align-items-start p-2"
                style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                <div class="d-flex justify-content-between w-100">
                    <div class="title-coomment py-1 ps-1 pe-3 d-flex justify-content-center align-items-center"
                    style="margin-top: -1rem; margin-left:-7px;">
                    <img src="{{ asset('pages/home/section-6/icon-comment.png') }}" alt="icon" class="img-fluid"
                ...
                <div class="lay-out-btn-accept px-1 py-3 ms-auto me-4 d-none d-md-block">
                ...
                <div class="d-flex flex-column justify-content-start align-items-center">
                    ...
                    <div class="lay-out-btn-accept px-1 py-3  me-4 d-block d-md-none">
                        <a href="#" class="btn-accept-comment p-2">กดโหวต</a>
                    </div>
                </div>
            </div>
