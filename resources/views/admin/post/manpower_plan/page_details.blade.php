...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="margin-top: 5%;">
        <div class="modal-content">
            ...
            <form action="{{ route('ManpowerPlanDetailCreate',$ManpowerPlanType->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<table class="table table-bordered" id="data_table">
    ...
    <tbody>
        @foreach ($ManpowerPlanFile as $index => $details)
        <tr>
            ...
            <td class="text-center">
                ...
                <form action="{{ route('ManpowerPlanDetailDelete', $details->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
