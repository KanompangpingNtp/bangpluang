        ...
        <div class="modal-content">
            ...
            <form action="{{route('ContactCreate')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="logo_file" class="form-label">รูปโลโก้</label>
                        <input type="file" class="form-control" id="logo_file" name="logo_file" required>
                    </div>
                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="เนื้อหา" id="details" name="details"></textarea>
                        </div>
                    </div>
                    <div class="mb-3">
...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <img src="{{ asset('storage/' . $contact->logo_file) }}" alt="โลโก้" width="120" class="mb-3">
            @else
            ...
            <form action="{{ route('ContactUpdate', $contact->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <p><strong>ไฟล์ปัจจุบัน:</strong> <a href="{{ asset('storage/' . $contact->logo_file) }}" target="_blank">ดูไฟล์</a></p>
                        @endif
                    </div>

                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="รายละเอียด" id="details" name="details">{{ old('details', $contact->details) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p><strong>ไฟล์ปัจจุบัน:</strong> <a href="{{ asset('storage/' . $contact->payment_file) }}" target="_blank">ดูไฟล์</a></p>
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p><strong>ไฟล์ปัจจุบัน:</strong> <a href="{{ asset('storage/' . $contact->contact_administration_file) }}" target="_blank">ดูไฟล์</a></p>
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p><strong>ไฟล์ปัจจุบัน:</strong> <a href="{{ asset('storage/' . $contact->contact_finance_file) }}" target="_blank">ดูไฟล์</a></p>
                        @endif
                    </div>
