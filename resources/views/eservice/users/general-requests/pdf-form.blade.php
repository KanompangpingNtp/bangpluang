...
<body>
    ...
    <div class="box_text" style="text-align: right;">
        <span style="line-height: 0.7;">
            องค์การบริหารส่วนตำบลบางพลวง <br>
            104 หมู่ 3 ตำบลบางพลวง <br>
    ...
    <div class="box_text" style="text-align: left;">
        <span>เรียน นายกองค์การบริหารส่วนตำบลบางพลวง</span>
    </div>
    <div class="box_text" style="text-align: left;">
    ...
    <div class="box_text" style="text-align: left; margin-left:5rem">
        <span>เรื่องที่ร้องต่อองค์การบริหารส่วนตำบลบางพลวง กรณี</span><span class="dotted-line"
            style="min-width: 50%; text-align: start;">{{ $form->request_details }}</span>
    </div>
    <div class="box_text" style="text-align: left;">
        <span style="margin-left:5rem;">ข้าพเจ้าขอความอนุเคราะห์ให้องค์การบริหารส่วนตำบลบางพลวง ดำเนินการ</span>
